...
if ($_POST)
{
  ...
  echo  $sql="update  personas set nombres= '".$_POST['nombres']."', apellidos='".$_POST['apellidos']."',fecha_nac='".$_POST['fecha']."' where id=".$_POST['id'];
...
$res=mysqli_query($conex,$sql);
 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     ...
     <form class="" action="perso_editar.php?id=<?php echo $_GET['id']; ?>" method="post">
